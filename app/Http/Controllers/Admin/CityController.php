...
class CityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin_all_city'))->with('success','City Created successfully');;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('admin_all_city'))->with('success','City updated successfully');;
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('admin_all_city'))->with('success','City deleted successfully');
    }
