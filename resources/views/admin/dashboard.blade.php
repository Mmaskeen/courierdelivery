...
{{--                <a href="{{url('order/invoice') }}">Invoice</a>--}}
            </div>

            <div class="row row-cards">
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'overAll', 'statusFilter' => 'Latest'])}}">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'overAll', 'statusFilter' => 'Dispatched'])}}">
                            <div class="card-body text-center">
                                <div class="h1 m-0"><i class="fa fa-truck text-primary"></i><strong> {{$overAll['totalDispatched']}}</strong></div>
                                <div class="text-muted mb-0"> Total Dispatched</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'overAll', 'statusFilter' => 'Canceled'])}}">
                            <div class="card-body text-center">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'overAll', 'statusFilter' => 'Proceeded'])}}">
                            <div class="card-body text-center">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'overAll', 'statusFilter' => 'Hold Order'])}}">
                            <div class="card-body text-center">
            ...
            <div class="row row-cards">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'today', 'statusFilter' => 'Dispatched'])}}">
                            <div class="card-body text-center">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'today', 'statusFilter' => 'Canceled'])}}">
                            <div class="card-body text-center">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_all_order',['type' => 'today', 'statusFilter' => 'Hold Order'])}}">
                            <div class="card-body text-center">
                ...
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="card">
                        <a href="{{route('admin_trashed_order',['type' => 'today'])}}">
                            <div class="card-body text-center">
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            window.setTimeout(function(){location.reload()},500000);
            ...
            $("#search").bind('blur keyup', function(e) {
                if (e.type === 'blur' || e.keyCode === 13) {
                    ...
                    e.preventDefault();
                    let url = "{{route('admin_all_order', ['searchOrder' => 'searchValue'])}}";
