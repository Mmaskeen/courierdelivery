                            ...
                            <table class="table card-table table-vcenter text-nowrap" id="table_id">
                                ...
                                @forelse($orders as $order)
                                    <tr>
                                        ...
                                        <td><span class="text-muted orderId">{{$order->order_id}}</span></td>
                                        ...
                                        <td>
                                            <div class="btn-group mt-2 mb-2">
                                                ...
                                                <form action="{{route('admin_restore_order',['order' => $order->id])}}" method="post" class="btnform">
                                                    @csrf
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#restoreOrders',function (e) {
                ...
                if(orders.length === 0){
                    ...
                    let url = "{{route('admin_restore_order')}}";
