                ...
                @if( request('type') == 'overAll' && request('statusFilter') == 'Latest' ||request('type') == 'today')
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 col-sm-12">
                        <div class="card card-counter bg-gradient-teal">
                            <a href="{{route('admin_dispatch_orders')}}">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="mt-4 mb-0 text-white">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <ul class="order_filters static">
                                        <form id="orderFilterForm" class="filterform" action="{{route('admin_filter_order')}}" method="get">
                                        ...
                                        <li><form class="float-left">
                                                {{--                                        <button type="submit" class="btn btn-primary" id="deleteAll"><i class="fa fa-trash mr-2" onclick="return confirm('Are you sure you want to delete selected Order?');"></i>Delete All</button>--}}
                                                <select name="bulk-action" class="form-control" id="deleteAll">
                                                    <option value="" disabled selected>Action</option>
                                                    <option data-type="delete" value="delete">Delete All</option>
                                                    <option data-type="status" value="Hold Order">On Hold</option>
                                                    {{--                                                    <option data-type="status" value="Dispatched">Dispatch</option>--}}
                                                    <option data-type="status" value="Latest">Latest</option>
                                                    <option data-type="status" value="Canceled">Canceled</option>
                                                    <option data-type="status" value="Proceeded">Proceeded</option>
                                                </select>
                                            </form></li>

                                        <li class="exportas">
                                            <div class="filter-export">
                                                <form action="{{route('export',request()->all())}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <button type="submit" class="btn btn-primary"><i class="fa fa-download mr-2"></i>Export Order</button>
                                                </form>
                                            </div>
                                        </li>
                                        <li class="exportas">
                                            <div class="filter-export">
                                                <form action="{{route('admin_sync_record')}}" method="get">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','.isReturned',function (e) {
                if($(this).prop("checked") == false){
                    ...
                    let url = '{{route('admin_received_parcel','id')}}';
            ...
            $(document).on('click','.changeStatus',function (e) {
                ...
                let url ='{{route('admin_update_order_status','id')}}';
            ...
            $(document).on('change','.orderDateFilter',function (e) {
                ...
                let url = '{{route('admin_filter_order')}}';
                let data = {
                    "fromDate" : fromDate,
                    "toDate" : toDate,
                };
            ...
            // $(document).on('blur  keyup', '#', function (e) {
            ...
            $("select[name='bulk-action']" ).on('change',function (e) {
                ...
                if (orders.length == 0 ){
                    ...
                    let url = "{{route('admin_delete_multiple_order')}}";
