                            ...
                            <table class="table card-table table-vcenter text-nowrap" id="table_id">
                                ...
                                @forelse($users as $user)
                                    <tr>
                                        ...
                                        <td>{{$user->email}}</td>
                                        <td>{{$user->phone}}</td>
                                        <td>{{str_limit($user->bio,30)}}</td>
                                        <td>
                                            <a href="{{route('admin_edit_rider',$user->id)}}" class="at-actionbtn at-edit-icon btn" ><i class="fa fa-edit"></i></a>
                                            <form id="deleteForm{{$user->id}}"  action="{{route('admin_delete_rider',[$user->id])}}" method="post" class="btnform">
