        ...
        <div class="container-fluid">
            <div class="page-header">
                ...
                <div class="input-group w-30">
                    <form action="{{route('employee_all_city')}}" method="get" >
                            ...
                            <a href="client-detail.php">
                                <div class="card-body">
                                    <div class="media mt-0">
                                        ...
                                        <form action="{{route('employee_edit_city',$city->id)}}" method="get" >
                                            <button type="submit" class="btn btn-info d-none d-sm-block mr-2"><i class="fe fe-edit-3"></i> </button>
                                        </form>
{{--                                        <form id="deleteForm{{$city->id}}" action="{{route('employee_delete_city',[$city->id])}}" method="post" class="btnform">--}}
